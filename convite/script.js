document.addEventListener('DOMContentLoaded', () => {
    ...
    rsvpForm.addEventListener('submit', (e) => {
        ...
        let text = `Olá! Quero confirmar minha presença no evento de 1 ano do Instituto Pomus.%0A%0A*Nome:* ${name}`;
        if (companions === "1") {
            text += `%0A*Acompanhante:* Sim, 1 pessoa.`;
        } else {
            text += `%0A*Acompanhante:* Não, irei sozinho(a).`;
        }
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                submitBtn.innerHTML = '<span class="btn-text">Confirmar Presença ✨</span>';
